			...
			<el-footer>
				<div class="footer">
					<div class="all-words-wrapper">
						<a class="footer-link" href="https://www.evaluation.com" target="_blank">政务服务好差评管理员系统</a>
						<span class="dian"> | </span>
						<a class="footer-link" href="https://www.samr.gov.cn/" target="_blank">国家市场监督管理局</a>
						<span class="dian"> | </span>
						<a class="footer-link" href="https://gjzwfw.www.gov.cn/index.html" target="_blank">国家政务服务平台</a>
						<span class="dian"> | </span>
						<a class="footer-link" href="https://hcp.samr.gov.cn/gbeval/html/guide.html" target="_blank">政务服务好差评系统</a>
						<span class="dian"> | </span>
						<a class="footer-link" href="https://github.com/jgl020412/EvaluationSystem" target="_blank">Github</a>
						<span class="dian" style="font-size: 12px; margin-left: 20px;">Copyright © 2020 JGL.evaluatino.com All Rights Reserved</span>
					</div>
				</div>
			</el-footer>
		</el-container>
